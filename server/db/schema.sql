-- ====================================================================
-- SellPilot Production Relational Database Schema (PostgreSQL)
-- Multi-tenant isolation for Nigerian Social Commerce Merchants
-- ====================================================================
...
-- 14. SUBSCRIPTIONS (One active subscription per business)
...
-- 15. USAGE RECORDS (Enforces server-side limits per billing period)
...
-- 16. PAYMENTS (Audit log & verification tracking for Paystack/gateway transactions)
...
-- ====================================================================
-- PERFORMANCE INDEXES (Optimized for Multi-tenant isolation & common queries)
-- ====================================================================
...
CREATE INDEX IF NOT EXISTS idx_subscriptions_biz_id ON subscriptions(business_id);
CREATE INDEX IF NOT EXISTS idx_subscriptions_status ON subscriptions(status);
CREATE INDEX IF NOT EXISTS idx_subscriptions_trial_ends ON subscriptions(trial_ends_at);
CREATE INDEX IF NOT EXISTS idx_usage_records_biz_metric ON usage_records(business_id, metric, period_start, period_end);
